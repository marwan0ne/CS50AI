...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.make_sentence(cell, countcopy)
        self.updating_knowledge()
        self.inference()
    ...
    def make_random_move(self):
        ...
        """
        maxmoves = self.height * self.width
        while maxmoves > 0:
            maxmoves -=1
    ...
    def make_sentence(self, cell,count):
        new_cells = set()
        cells = set()
        neighbors = self.neighbors_position(cell)
        ...
        for cell in new_cells:
            if cell in self.mines:
                count -=1
            elif cell not in self.mines | self.safes:
                cells.add(cell)
    ...
    def neighbors_position(self,cell):
        neighbors = []
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
        ...
        return neighbors
    def updating_knowledge(self):
        updated_knowldge = copy.deepcopy(self.knowledge)
        for sentence in updated_knowldge:
